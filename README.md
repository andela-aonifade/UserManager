...
* Clone the repository by entering the command `git clone https://github.com/andela-aonifade/UserManager` in the terminal.
...
```
* After cloning run `docker-compose build` && `docker-compose up`.
